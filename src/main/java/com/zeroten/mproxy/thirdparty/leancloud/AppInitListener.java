...
import com.zeroten.mproxy.thirdparty.leancloud.hook.ImHook;
...
public class AppInitListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent arg0) {
        ...
        LeanEngine.addSessionCookie(new EngineSessionCookie("s4sk", 3600, true));
        ...
        // 向云引擎注册云函数
        LeanEngine.register(ImHook.class);
    }
}
